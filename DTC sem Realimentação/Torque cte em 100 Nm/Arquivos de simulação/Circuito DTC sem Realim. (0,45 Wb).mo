model controletrif
  ...
  Modelica.Blocks.Sources.RealExpression Vel_Ref(y = 100)  annotation(
    Placement(visible = true, transformation(origin = {25, -242}, extent = {{-13, -16}, {13, 16}}, rotation = 0)));
  ...
  Modelica.Mechanics.Rotational.Sources.ConstantSpeed constantSpeed(w_fixed = 100)  annotation(
    Placement(visible = true, transformation(origin = {253, 51}, extent = {{17, -17}, {-17, 17}}, rotation = 0)));
equation
  ...
  connect(Vel_Ref.y, histerese_3.Tr) annotation(
    Line(points = {{40, -242}, {146, -242}, {146, -226}, {230, -226}}, color = {0, 0, 127}));
  connect(Motor.flange, constantSpeed.flange) annotation(
    Line(points = {{98, 32}, {208, 32}, {208, 51}, {236, 51}}));
  connect(constantSpeed.support, Acoplamento2.flange) annotation(
    Line(points = {{254, 34}, {260, 34}, {260, -4}}));
protected
  annotation(
